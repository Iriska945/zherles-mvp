...
export default function HomePage() {
  ...
  return (
    <div className="space-y-10 pb-12">
      ...
      <section className="bg-slate-900 dark:bg-slate-900 text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden border border-slate-800/40">
        ...
        <div className="relative max-w-3xl space-y-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-950/80 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-bold text-emerald-300 border border-emerald-500/30">
              ...
              <span>{t('landing.hero.live', { count: totalBusinessesCount })}</span>
            </div>
          </div>
          ...
          <div className="pt-2 flex flex-wrap gap-4">
            ...
            >
              ...
              <span>{t('landing.hero.btn.b2b')}</span>
            </Link>
            ...
            >
              ...
              <span>{t('landing.hero.btn.b2c')}</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1 transition-colors">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            <span className="text-xs font-medium">{t('landing.metrics.partners')}</span>
            <Building2 className="w-4 h-4 text-blue-600 dark:text-blue-400" />
          </div>
          <p className="text-2xl font-extrabold text-slate-900 dark:text-white">{totalBusinessesCount}</p>
          <p className="text-xs text-slate-500 dark:text-slate-400 text-ellipsis overflow-hidden whitespace-nowrap">
            {t('landing.metrics.activeLinks', { count: activePartnersCount })}
          </p>
        </div>

        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1 transition-colors">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            <span className="text-xs font-medium">{t('landing.metrics.campaigns')}</span>
            <Tag className="w-4 h-4 text-purple-600 dark:text-purple-400" />
          </div>
          <p className="text-2xl font-extrabold text-slate-900 dark:text-white">{state.campaigns.length}</p>
          <p className="text-xs text-slate-500 dark:text-slate-400">{t('landing.metrics.campaignsSub')}</p>
        </div>

        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1 transition-colors">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            <span className="text-xs font-medium">{t('landing.metrics.clients')}</span>
            <Award className="w-4 h-4 text-amber-600 dark:text-amber-400" />
          </div>
          <p className="text-2xl font-extrabold text-slate-900 dark:text-white">{state.clients.length}</p>
          <p className="text-xs text-slate-500 dark:text-slate-400">{t('landing.metrics.clientsSub')}</p>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-emerald-950 to-slate-900 text-white p-8 rounded-3xl shadow-lg border border-emerald-900/50 dark:border-emerald-800/40 flex flex-col justify-between space-y-6 relative overflow-hidden">
          <div className="space-y-3 relative z-10">
            <div className="inline-flex items-center gap-2 bg-emerald-500/20 text-emerald-300 text-xs font-bold px-3 py-1 rounded-full border border-emerald-500/30">
              ...
              <span>{t('landing.banner.b2b.badge')}</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              {t('landing.banner.b2b.title')}
            </h2>
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
              {t('landing.banner.b2b.desc')}
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3 relative z-10">
            ...
            >
              ...
              <span>{t('landing.banner.b2b.btn.dashboard')}</span>
            </Link>
            ...
            >
              <span>{t('landing.banner.b2b.btn.connect')}</span>
        ...
        <div className="bg-gradient-to-br from-blue-950 to-slate-900 text-white p-8 rounded-3xl shadow-lg border border-blue-900/50 dark:border-blue-800/40 flex flex-col justify-between space-y-6 relative overflow-hidden">
          <div className="space-y-3 relative z-10">
            <div className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 text-xs font-bold px-3 py-1 rounded-full border border-blue-500/30">
              ...
              <span>{t('landing.banner.b2c.badge')}</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              {t('landing.banner.b2c.title')}
            </h2>
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
              {t('landing.banner.b2c.desc')}
            </p>
          </div>
